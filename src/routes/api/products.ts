...
import { handleImageUpload, handleProductImageUpdate } from '../../controllers/upload/uploadController';
...
router
  .route('/imageUpload')
  .post(verifyJWT, verifyRoles(ROLES_LIST.Admin, ROLES_LIST.Editor), singleFileUpload, handleImageUpload);

router
  .route('/:id/image')
  .put(verifyJWT, verifyRoles(ROLES_LIST.Admin, ROLES_LIST.Editor), singleFileUpload, handleProductImageUpdate);
